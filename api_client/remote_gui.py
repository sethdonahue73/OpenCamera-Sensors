...
HOST = '192.168.4.245'  # Smartphone's IP address
...
class RemoteControlGUI:
    def __init__(self, master):
        ...
        tk.Label(file_frame, text="Filename:").pack(side=tk.LEFT, padx=(0, 5))
        self.filename_entry = tk.Entry(file_frame, width=40)
        self.filename_entry.insert(0, "recorded_video.mp4")
        self.filename_entry.pack(side=tk.LEFT)

        self.path_button = tk.Button(file_frame, text="Choose
